package com.seeyon.cmp.common.utils.network;
...
import com.seeyon.cmp.common.utils.ShellUtils;
...
public class NetworkUtils {
    ...
    public static String getNetworkState(Context context) {
        String networkType = CMPNetinfo.C_sConnectionStatus_None;
        NetworkInfo info = getActiveNetworkInfo(context);
        if (info != null && info.isAvailable()) {
            if (info.getType() == ConnectivityManager.TYPE_MOBILE) {
                networkType = CMPNetinfo.C_sConnectionStatus_Cellular;
            } else {//不是移动网络，就是wifi？
                networkType = CMPNetinfo.C_sConnectionStatus_Wifi;
            }
        }
        return networkType;
    }
